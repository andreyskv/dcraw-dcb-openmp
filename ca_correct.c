...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
int LinEqSolve(int nDim, float* pfMatr, float* pfVect, float* pfSolution)
{
//==============================================================================
...
//#define border2	16
	...
	const float clip_pt = 1.0 / MIN(MIN(pre_mul[0],pre_mul[1]),pre_mul[2]);  //  1.0 / MIN(MIN(m_D65Multipliers[0],m_D65Multipliers[1]),m_D65Multipliers[2]);
